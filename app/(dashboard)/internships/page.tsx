...
export default function InternshipsPage() {
  ...
  const filteredInternships = mockProjectTemplates
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-secondary-600 mb-3">
                ...
                <Link href="/internship" className="text-primary font-semibold hover:underline">
                  Internships
                </Link>{" "}
                page to select your duration and get a personalized plan based on these projects.
              </p>
              <Button
                variant="outline"
                size="sm"
      ...
      {filteredInternships.length > 0 ? (
        ...
        <Card className="border-secondary-200">
          <CardContent className="py-14 text-center">
            ...
            <div className="text-lg font-semibold text-secondary-900">No internships found</div>
            <p className="mt-1 text-sm text-secondary-500">
